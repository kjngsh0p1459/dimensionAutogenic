package com.dimenify.modified.action;

import com.dimenify.modified.model.Dimen;
import com.dimenify.modified.util.Constants;
import com.dimenify.modified.util.ModelUtil;
...
public abstract class AbstractDimenAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        data = ModelUtil.fromJson(PropertiesComponent.getInstance().getValue(SAVE_PREFIX_V2, Constants.INIT_MODEL_JSON));
